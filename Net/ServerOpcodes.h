...
namespace ms
{
	// Every opcode the server can send, mirroring its net/opcodes/SendOpcode.java.
	// The numbers are the wire protocol: keep this list in sync with the server
	// enum, including the opcodes the client does not act on yet.
